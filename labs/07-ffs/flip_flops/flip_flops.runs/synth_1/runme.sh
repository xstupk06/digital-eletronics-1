...
HD_PWD='C:/Stupka/digital-eletronics-1/labs/07-ffs/flip_flops/flip_flops.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log t_ff_rst.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source t_ff_rst.tcl
